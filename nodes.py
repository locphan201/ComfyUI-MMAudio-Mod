...
model: ModelConfig = ModelConfig(
    ...
    model_path=folder_paths.get_full_path_or_raise('mmaudio', 'mmaudio_large_44k_v2.pth'),
    vae_path=folder_paths.get_full_path_or_raise('mmaudio', 'v1-44.pth'),
    bigvgan_16k_path=None,
    mode = '44k',
    synchformer_ckpt=folder_paths.get_full_path_or_raise('mmaudio', 'synchformer_state_dict.pth'),
)
